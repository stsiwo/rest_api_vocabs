...
describe('UserRepository', function() {
  ...
  describe('#upsertWordsOfUser', function() {
  ...
  describe('#checkUserNameUnique', function() {
  ...
  describe('#checkEmailAlreadyExist', function() {
  ...
  describe('#signUp', function() {
    it('create new user', async function() {
      const testUser = { name: "test_user", email: "test@gmail.com", password: "mypassword" };
      const isSignUpCompleted = await userRepo.signUp(testUser.name, testUser.email, testUser.password);
      expect(isSignUpCompleted).toEqual(true);
    });
  })
});
